...
class ExcelGenerator {
  Future<bool> createExcel(List<TicketReportItem> ticketList) async {
...
// Set the text value.
    ...
    sheet.getRangeByName('B1')
      ..setText('Ticket Number')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 22;
    sheet.getRangeByName('C1')
      ..setText('Organization')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 18;
    sheet.getRangeByName('D1')
      ..setText('User Email')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 24;
    sheet.getRangeByName('E1')
      ..setText('Ticket Price')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 10;
    sheet.getRangeByName('F1')
      ..setText('Issued Time')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 22;
    sheet.getRangeByName('G1')
      ..setText('Is Scanned')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 12;
    sheet.getRangeByName('H1')
      ..setText('Scanned Time')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 22;
    sheet.getRangeByName('I1')
      ..setText('Category')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 27;
    sheet.getRangeByName('J1')
      ..setText('Subcategory')
      ..cellStyle.hAlign = HAlignType.center
      ..columnWidth = 20;
    ...
    for (TicketReportItem ticketItem in ticketList) {
      ...
      sheet.getRangeByName('D$i').setText('${ticketItem.userEmail}');
      sheet.getRangeByName('E$i')
        ..cellStyle.hAlign = HAlignType.center
        ..setText('${ticketItem.price}');
...
//Get the storage folder location using path_provider package.
    ...
    String filename =
        "TicketReport${DateFormat().addPattern("dd-MM-yyyy-hh-mm").format(DateTime.now())}";
    log('$path\\$filename.xlsx');

    final File file = File(Platform.isWindows ? '$path\\$filename.xlsx' : '$path/$filename.xlsx');
    await file.writeAsBytes(bytes, flush: true);
    if (Platform.isWindows) {
      await Process.run('start', <String>['$path\\$filename.xlsx'], runInShell: true);
    } else if (Platform.isMacOS) {
      await Process.run('open', <String>['$path/$filename.xlsx'], runInShell: true);
    } else if (Platform.isLinux) {
      await Process.run('xdg-open', <String>['$path/$filename.xlsx'], runInShell: true);
    }
    return true;
  }
  ...
  Future<void> generateExcel() async {
    ...
    sheet.getRangeByName('F11').numberFormat = r'[$-x-sysdate]dddd, mmmm dd, yyyy';
    ...
    //Dispose the document.
    workbook.dispose();
    File a = File('Output.xlsx');
    await a.writeAsBytes(bytes);
    //Save and launch the file.
    OpenFile.open('Output.xlsx');
  }
}
